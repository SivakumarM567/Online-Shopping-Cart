...
namespace WebApplication5.Controllers
{
    ...
    public class UserDetailsController : ControllerBase
    {
        ...
        public IActionResult GetUserbyEmail(string EmailId,string Password,string Role)
        {
            return Ok(_userDetailsServices.GetUserbyEmail(EmailId,Password,Role));
        }
        #endregion
        ...
        {
            var user = _userDetailsServices.GetUserbyEmail(model.EmailId,model.Password,model.Role);
            ...
            {
                return BadRequest(new { message = "Write valid details" });
            }
